...
const account = () => {
    ...
    const arr2 = [
        {
            title: "Desert Oasis",
            prize: "$180 per night",
            url: "https://plus.unsplash.com/premium_photo-1663040271283-bd044a62da1a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjl8fHBsYWNlc3xlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            title: "Forest Retreat",
            prize: "$160 per night",
            url: "https://plus.unsplash.com/premium_photo-1718285549233-42414e1c16f9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cGxhY2VzfGVufDB8fDB8fHww"
        },
        {
            title: "Lakeside Cottage",
            prize: "$130 per night",
            url: "https://images.unsplash.com/photo-1705346435684-a9de6cbb53dc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8cGxhY2VzfGVufDB8fDB8fHww"
        },
        {
            title: "Countryside Bungalow",
            prize: "$140 per night",
            url: "https://images.unsplash.com/photo-1728920823701-13048f597699?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHBsYWNlc3xlbnwwfHwwfHx8MA%3D%3D"
        },
        {
            title: "Ski Resort Chalet",
            prize: "$250 per night",
            url: "https://images.unsplash.com/photo-1714466330772-097c1f9c43cb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHBsYWNlc3xlbnwwfHwwfHx8MA%3D%3D"
        }
    ];
  ...
  return (
    ...
    <div className="sidebar sticky top-0 w-[25vw] h-screen flex flex-col items-center p-10 gap-6 border-r-2">
        <div className="imgcont w-[60%] aspect-square rounded-full overflow-hidden bg-red-500">
        <img src="https://nofilmschool.com/media-library/walter-white.jpg?id=34060287&width=980" alt="" className='w-full h-full object-cover'/></div>
    ...
    <div className="right w-[70vw] py-8 flex-col ">
        <div className="uppercont w-full z-40 sticky py-8 backdrop-blur-md top-0 flex  justify-between px-3">
            ...
            <NavLink to='/account/booking' className={({ isActive })=>`nav-item px-6 py-4 rounded-full text-white ${isActive ? "bg-main" : "bg-white text-neutral-700"}`}>My Bookings</NavLink>
            <NavLink to='/account/accommodation' className={(e)=>`px-6 py-4 rounded-full text-white ${e.isActive?'bg-main':'bg-white text-neutral-700'}`}>My Accodomation</NavLink>
            </div>
